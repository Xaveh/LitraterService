...
public sealed class DeleteAuthorCommandHandlerTests
{
    ...
    public DeleteAuthorCommandHandlerTests()
    {
        ...
        _handler = new DeleteAuthorCommandHandler(_authorCommandRepositoryMock.Object, _unitOfWorkMock.Object);
    }
    ...
    public async Task Handle_WhenAuthorExists_ShouldDeleteAuthorSuccessfully()
    {
        ...
        _authorCommandRepositoryMock.Verify(x => x.GetByIdAsync(authorId, It.IsAny<CancellationToken>()), Times.Once);
        _authorCommandRepositoryMock.Verify(x => x.Delete(author), Times.Once);
    ...
    public async Task Handle_WhenAuthorDoesNotExist_ShouldReturnNotFoundResult()
    {
        ...
        _authorCommandRepositoryMock.Verify(x => x.GetByIdAsync(authorId, It.IsAny<CancellationToken>()), Times.Once);
        _authorCommandRepositoryMock.Verify(x => x.Delete(It.IsAny<Author>()), Times.Never);
