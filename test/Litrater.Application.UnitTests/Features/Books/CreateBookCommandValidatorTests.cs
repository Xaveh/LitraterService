...
public sealed class CreateBookCommandValidatorTests
{
    ...
    {
        // Arrange
        var command = new CreateBookCommand("Test Book", "1234567890123", [Guid.NewGuid(), Guid.NewGuid()]);
    ...
    {
        // Arrange
        var command = new CreateBookCommand(title!, "1234567890123", [Guid.NewGuid()]);
    ...
    public void Validate_WhenTitleExceedsMaxLength_ShouldBeInvalid()
    {
        ...
        var command = new CreateBookCommand(longTitle, "1234567890123", [Guid.NewGuid()]);
    ...
    {
        // Arrange
        var command = new CreateBookCommand("Test Book", isbn!, [Guid.NewGuid()]);
    ...
    {
        // Arrange
        var command = new CreateBookCommand("Test Book", "1234567890123", []);
    ...
    {
        // Arrange
        var command = new CreateBookCommand("Test Book", "1234567890123", [Guid.NewGuid(), Guid.Empty]);
