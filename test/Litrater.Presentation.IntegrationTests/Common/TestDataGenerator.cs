...
public static class TestDataGenerator
{
    ...
    {
        public static Author Tolkien => new(new Guid("16cf3c8d-fa5b-418a-ac3f-2ab55ebcb8b9"), new PersonName("J.R.R.", "Tolkien"));
        public static Author Rowling => new(new Guid("1d36391f-5d03-4a1d-8c07-0ff35f421bdb"), new PersonName("J.K.", "Rowling"));
        public static Author Herbert => new(new Guid("24610d22-961d-4a06-b2c3-40aaf247f3c8"), new PersonName("Frank", "Herbert"));
        public static Author Asimov => new(new Guid("41120f1c-c0e6-41ff-8bb5-9f5c5ec85a88"), new PersonName("Isaac", "Asimov"));
    }
